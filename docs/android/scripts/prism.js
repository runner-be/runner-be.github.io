...
var _self = 'undefined' != typeof window ? window : 'undefined' !=
  typeof WorkerGlobalScope && self instanceof WorkerGlobalScope ? self : {},
  Prism = function (u) {
    var c = /\blang(?:uage)?-([\w-]+)\b/i, n = 0, e = {}, M = {
      ...
      util: {
        encode: function e (n) {
          return n instanceof W
            ...
            : Array.isArray(n) ? n.map(e) : n.replace(/&/g, '&amp;').
              replace(/</g, '&lt;').
              replace(/\u00a0/g, ' ')
        },
        type: function (e) {
        ...
        objId: function (e) {
          return e.__id ||
          Object.defineProperty(e, '__id', { value: ++n }), e.__id
        },
        clone: function t (e, r) {
          ...
          switch (r = r || {}, M.util.type(e)) {
            case'Object':
              ...
              for (var i in a = {}, r[n] = a, e) e.hasOwnProperty(i) &&
              (a[i] = t(e[i], r))
              return a
            case'Array':
              return n = M.util.objId(e), r[n]
                ? r[n]
                : (a = [], r[n] = a, e.forEach(
                  function (e, n) {a[n] = t(e, r)}), a)
            default:
              return e
          }
        },
      ...
      languages: {
        ...
        insertBefore: function (t, e, n, r) {
          ...
          var s = r[t]
          return r[t] = i, M.languages.DFS(M.languages,
            function (e, n) {n === s && e != t && (this[e] = i)}), i
        },
        DFS: function e (n, t, r, a) {
          ...
          for (var l in n) if (n.hasOwnProperty(l)) {
            ...
            'Object' !== s || a[i(o)] ? 'Array' !== s || a[i(o)] ||
              (a[i(o)] = !0, e(o, t, l, a)) : (a[i(o)] = !0, e(o, t, null, a))
          }
        },
      },
      plugins: {},
      ...
      highlightAllUnder: function (e, n, t) {
        ...
        M.hooks.run('before-highlightall',
          r), r.elements = Array.prototype.slice.apply(
          r.container.querySelectorAll(r.selector)), M.hooks.run(
          'before-all-elements-highlight', r)
        for (var a, i = 0; a = r.elements[i++];) M.highlightElement(a, !0 === n,
          r.callback)
      },
      highlightElement: function (e, n, t) {
        ...
        function o (e) {
          l.highlightedCode = e, M.hooks.run('before-insert',
            l), l.element.innerHTML = l.highlightedCode, M.hooks.run(
            'after-highlight', l), M.hooks.run('complete', l), t &&
          t.call(l.element)
        }

        if (M.hooks.run('before-sanity-check',
          l), (i = l.element.parentElement) && 'pre' ===
        i.nodeName.toLowerCase() && !i.hasAttribute('tabindex') &&
        i.setAttribute('tabindex', '0'), !l.code) return M.hooks.run('complete',
          l), void (t && t.call(l.element))
        ...
        } else o(M.highlight(l.code, l.grammar, l.language)) else o(
          M.util.encode(l.code))
      },
      highlight: function (e, n, t) {
        ...
        return M.hooks.run('before-tokenize', r), r.tokens = M.tokenize(r.code,
          r.grammar), M.hooks.run('after-tokenize', r), W.stringify(
          M.util.encode(r.tokens), r.language)
      },
        ...
        return I(a, a.head, e), function e (n, t, r, a, i, l) {
          for (var o in r) if (r.hasOwnProperty(o) && r[o]) {
            ...
            for (var u = 0; u < s.length; ++u) {
              ...
              var c = s[u], g = c.inside, f = !!c.lookbehind, h = !!c.greedy,
                d = c.alias
              ...
              for (var v = c.pattern || c, m = a.next, y = i; m !== t.tail &&
              !(l && y >= l.reach); y += m.value.length, m = m.next) {
                ...
                if (!(b instanceof W)) {
                  ...
                  if (h) {
                    ...
                    for (P += m.value.length; P <=
                    w;) m = m.next, P += m.value.length
                    if (P -= m.value.length, y = P, m.value instanceof
                    W) continue
                    for (var E = m; E !== t.tail && (P < A || "string" ==
                      typeof E.value); E = E.next) x++, P += E.value.length
                    x--, b = n.slice(y, P), k.index -= y
                  } else if (!(k = z(v, 0, b, f))) continue
                  var w = k.index, S = k[0], O = b.slice(0, w),
                    L = b.slice(w + S.length), N = y + b.length
                  ...
                  if (m = I(t, j, C), L && I(t, m, L), 1 < x) {
                    ...
                    e(n, t, r, m.prev, y, _), l && _.reach > l.reach &&
                    (l.reach = _.reach)
                  }
                }
              }
    ...
    function W (
      e, n, t, r) {
      this.type = e, this.content = n, this.alias = t, this.length = 0 |
        (r || '').length
    }
    ...
    if (u.Prism = M, W.stringify = function n (e, t) {
      ...
      var l = ''
      for (var o in a.attributes) l += ' ' + o + '="' +
        (a.attributes[o] || '').replace(/"/g, '&quot;') + '"'
      return '<' + a.tag + ' class="' + a.classes.join(' ') + '"' + l + '>' +
        a.content + '</' + a.tag + '>'
    }, !u.document) return u.addEventListener &&
    (M.disableWorkerMessageHandler || u.addEventListener('message',
      function (e) {
        var n = JSON.parse(e.data), t = n.language, r = n.code,
          a = n.immediateClose
...
Prism.languages.markup = {
  ...
  entity: [
    ...
    /&#x?[\da-f]{1,8};/i],
}, Prism.languages.markup.tag.inside['attr-value'].inside.entity = Prism.languages.markup.entity, Prism.languages.markup.doctype.inside['internal-subset'].inside = Prism.languages.markup, Prism.hooks.add(
  'wrap', function (a) {
    'entity' === a.type &&
...
}), Prism.languages.html = Prism.languages.markup, Prism.languages.mathml = Prism.languages.markup, Prism.languages.svg = Prism.languages.markup, Prism.languages.xml = Prism.languages.extend(
  'markup',
...
Prism.languages.javascript = Prism.languages.extend('clike', {
  ...
  'javascript'), Prism.languages.markup.tag.addAttribute(
      ...
      'string' == typeof a && (a = [a]), a.forEach(function (a) {
        !function (a, e) {
          ...
          if (t) {
            ...
            (r = t[n] = { pattern: r }), Array.isArray(
              r)) for (var i = 0, s = r.length; i < s; i++) r[i] instanceof
            RegExp && (r[i] = { pattern: r[i] }), e(r[i]) else e(r)
          }
...
!function (e) {
  ...
  }), delete e.languages.kotlin['class-name'], e.languages.insertBefore(
    'kotlin', 'string', {
      'raw-string': {
        pattern: /("""|''')[\s\S]*?\1/,
        alias: 'string',
...
(Prism.plugins.KeepMarkup = !0, Prism.hooks.add('before-highlight',
  function (e) {
  ...
  if (n.keepMarkup && n.keepMarkup.length) {
    var a = function (e, n) {
      for (var o = 0, t = e.childNodes.length; o < t; o++) {
        ...
        if (1 === d.nodeType) {if (!a(d, n)) return !1} else 3 === d.nodeType &&
        (!n.nodeStart && n.pos + d.data.length > n.node.posOpen &&
        (n.nodeStart = d, n.nodeStartPos = n.node.posOpen -
          n.pos), n.nodeStart && n.pos + d.data.length >= n.node.posClose &&
        (n.nodeEnd = d, n.nodeEndPos = n.node.posClose -
          n.pos), n.pos += d.data.length)
        if (n.nodeStart && n.nodeEnd) {
          var r = document.createRange()
          return r.setStart(n.nodeStart, n.nodeStartPos), r.setEnd(n.nodeEnd,
            n.nodeEndPos), n.node.clone.appendChild(
            r.extractContents()), r.insertNode(n.node.clone), r.detach(), !1
        }
      }
      return !0
    }
